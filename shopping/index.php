							...
							<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
								...
								<div class="full-width-slider">
									<div class="item full-width-slider"
										style="background-image: url(assets/images/sliders/bag2.png);">
									</div><!-- /.item -->
								</div><!-- /.full-width-slider -->

								<div class="full-width-slider">
									<div class="item full-width-slider"
										style="background-image: url(assets/images/sliders/bag3.jpg);">
									</div><!-- /.item -->
								</div><!-- /.full-width-slider -->
												...
												<div class="product">
													...
													<div class="product-info text-left">
														...
														<div class="product-price">
															<span class="price">
																MMK.<?php echo htmlentities($row['productPrice']); ?>
															</span>
															<span
																class="price-before-discount">MMK.<?php echo htmlentities($row['productPriceBeforeDiscount']); ?>
															</span>
													...
													<?php if ($row['productAvailability'] == 'In Stock') { ?>
														<div class="action"><a
																...
																class="lnk btn btn-info"
																style="display:flex;align-items:center;justify-content:center;gap:10px;"><i
