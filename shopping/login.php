...
<head>
	...
	<!-- Premium Login CSS (Only for Login Page) -->
			...
			<div class="premium-navbar">
				...
				<div class="navbar-header">
					<a href="index.php" class="navbar-brand">
						<img src="assets/images/logo.svg" alt="Cherry Bags Store" class="logo-img">
					</a>
				</div>
				...
				<div class="navbar-menu">
					<ul class="nav navbar-nav">
						<li class="active border-0"><a href="index.php">Home</a></li>
						<li class="border-0"><a href="contact-us.php">Contact Us</a></li>
					</ul>
				</div>
			</div>
		</div>
