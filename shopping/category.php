												...
												<div class="col-sm-6 col-md-3 wow fadeInUp">
													<div class="products">
														<div class="product">
															...
															<div class="product-info text-left">
																...
																<div class="product-price">
																	...
																	<span class="price-before-discount">
																		MMK.<?php echo htmlentities($row['productPriceBeforeDiscount']); ?></span>
															...
															<?php } else { ?>
																<div class="action"
																	style="color:red; text-align:center; padding:10px; font-weight:bold; background:#f0f0f0; border-radius:50px;">
																	Out of Stock</div>
															<?php } ?>
														</div>
													</div>
